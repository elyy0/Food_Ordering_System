...
public class introduction{
	...
	{
		System.out.println("\t\t\tBadBoyZ Hotel");			//Hotel Name
		System.out.println("Welcome to Our Hotel");
		introduction obj1=new introduction();				//Creating the object of main class
		obj1.select_menu();									//obj1 is the object of the introduction class
	...
	public void select_menu()								//Menu Selection Function
	{
		...
		{
			case 1:												//For Starters
				starters st=new starters();						//Object creation of starters class
				st.starters();									//calling the function of starters class 
				break;
			case 2:												//For Main Course
				...
				break;
			case 3:												//For Desserts
				desserts des = new desserts();					//Object Creation
				des.desserts();									//Calling function
				break;
